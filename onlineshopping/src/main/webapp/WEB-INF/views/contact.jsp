		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>Rajajinagar <span>Bangalore, India.</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>Call Us</h4>
							<p>+91 9632772262<span>+91 96********</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="#">gouthamkum1993@gmail.com</a><span><a href="#">gouthamliferay1993@gmail.com</a></span></p>
						</div>
					</div>
						...
						<h4>For More <span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Telephone </p><span>+91 9632772262</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:info@example.com">gouthamkum1993@gmail.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Location</p><span>Rajajinagar, Bangalore, India.</span>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="col-md-6 contact-form">
						...
						<c:if test="${not empty message}">	
							...
							<div class="styled-input">
								<sf:input type="email" path="email" ></sf:input>
								<sf:errors path="email" cssClass="help-block" element="em"/>
								<label>Email</label>
								<span></span>
							</div> 
							<div class="styled-input">
								<sf:input type="text" path="subject" ></sf:input>
								<sf:errors path="subject" cssClass="help-block" element="em"/>
								<label>Subject</label>
								<span></span>
							</div>
							<div class="styled-input">
								<sf:input type="text" path="message" ></sf:input>
								<sf:errors path="message" cssClass="help-block" element="em"/>
								<label>Message</label>
								<span></span>
							</div>
							<%-- <div class="styled-input">
								<sf:textarea path="message" required></sf:textarea>
								<sf:errors path="message" cssClass="help-block" element="em"/>
								<label>Message</label>
								<span></span>
							</div>	  --%>
